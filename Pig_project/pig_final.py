...
# np.save('D:\\pig_project\\npy\\_train_3pig_x.npy', arr=xy_train[0][0])
# np.save('D:\\pig_project\\npy\\_train_3pig_y.npy', arr=xy_train[0][1])
# np.save('D:\\pig_project\\npy\\_test_3pig_x.npy', arr=xy_test[0][0])
# np.save('D:\\pig_project\\npy\\_test_3pig_y.npy', arr=xy_test[0][1])

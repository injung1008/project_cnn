...
# np.save('D:\\pig_project\\npy\\_train_only_cow3_x.npy', arr=xy_train[0][0])
# np.save('D:\\pig_project\\npy\\_train_only_cow3_y.npy', arr=xy_train[0][1])
# np.save('D:\\pig_project\\npy\\_test_only_cow3_x.npy', arr=xy_test[0][0])
# np.save('D:\\pig_project\\npy\\_test_only_cow3_y.npy', arr=xy_test[0][1])
...
# 0.6474 - acc: 0.6304
# e_loss :  [0.6473729014396667, 0.6304348111152649]
# acc :  0.5841425061225891
# loss :  0.789336621761322
# val acc :  0.6425619721412659
# val loss :  0.6431401968002319
# 원본 :  [[4.9977317e-01 4.5981932e-01 4.0407512e-02]
#  [5.3139019e-01 4.0707603e-01 6.1533794e-02]
#  [1.0237772e-04 5.6825038e-03 9.9421519e-01]
#  ...
#  [3.4035429e-01 4.0766472e-01 2.5198099e-01]
#  [3.8215392e-05 4.6300511e-03 9.9533170e-01]
#  [4.1272536e-01 5.0342256e-01 8.3852082e-02]]
# 예측값 :      0
# 0   0
# 1   0
# 2   2
...
# 28  2
# 29  2
# 원래값 :  [0. 1. 2. 1. 0. 1. 0. 1. 0. 1. 1. 0. 2. 2. 2. 1. 2. 2. 2. 2. 1. 2. 0. 0.
#  0. 0. 1. 2. 2. 2.]